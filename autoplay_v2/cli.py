...
from autoplay_v2.calibration import create_and_save_calibration, load_calibration
from autoplay_v2.config import AUTOPLAY_RUNS_DIR, CALIBRATION_PATH, DEFAULT_HOTKEY
...
def _cmd_hotkey(args: argparse.Namespace) -> int:
    calibration = load_calibration()
    hotkey = args.hotkey or calibration.trigger_hotkey or DEFAULT_HOTKEY
    ...
    run_hotkey_loop(_runner, hotkey=hotkey)
    return 0
...
def build_parser() -> argparse.ArgumentParser:
    ...
    calibrate.add_argument("--left", type=int, required=True)
    calibrate.add_argument("--top", type=int, required=True)
    calibrate.add_argument("--width", type=int, required=True)
    calibrate.add_argument("--height", type=int, required=True)
    ...
    calibrate.add_argument("--hotkey", type=str, default=DEFAULT_HOTKEY)
    ...
    hotkey.add_argument("--hotkey", type=str, default=None)
